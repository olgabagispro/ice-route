...
export function VesselDetail({ vessel, onBack, t }: VesselDetailProps) {
  return (
    <div className="w-full h-full min-h-0 overflow-y-auto bg-background custom-scrollbar">
      <div className="p-6 md:p-10 pb-32 md:pb-16 max-w-7xl mx-auto">
        ...
        >
          <ChevronLeft size={16} /> {t("backToFleetArchive")}
        </button>

        <div className="flex flex-col md:flex-row md:items-end justify-between gap-6 mb-12">
          <div className="space-y-2">
            <p className="text-[10px] font-bold font-mono text-secondary tracking-[0.3em] uppercase">{t("vesselProfile")}: {vessel.id}</p>
          ...
          <div className="lg:col-span-7 space-y-8">
            ...
            <div className="technical-card bg-surface-highest/5 border-outline/10 p-8 space-y-8">
              <div className="flex items-center gap-3 border-b border-outline/10 pb-4">
                ...
                <h3 className="text-[11px] font-bold font-mono text-on-surface tracking-[0.3em] uppercase">{t("technicalConfiguration")}</h3>
              </div>

              <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
                <div className="space-y-2">
                  <label className="text-[9px] font-bold font-mono text-on-surface-variant uppercase tracking-wider">{t("grossTonnageGt")}</label>
                ...
                <div className="space-y-2">
                  <label className="text-[9px] font-bold font-mono text-on-surface-variant uppercase tracking-wider">{t("hullCategory")}</label>
                  <div className="relative">
                    <select 
                      disabled
                    ...
                    >
                      <option selected>{vessel.iceClass} - {t("optimized")}</option>
                    </select>
                  </div>
                </div>

                <div className="space-y-2">
                  <label className="text-[9px] font-bold font-mono text-on-surface-variant uppercase tracking-wider">{t("engineOutput")}</label>
                  <div className="relative">
                    <input 
                      readOnly 
                ...
                <div className="space-y-2">
                  <label className="text-[9px] font-bold font-mono text-on-surface-variant uppercase tracking-wider">{t("beamWidth")}</label>
                  <div className="relative">
                    <input 
                      readOnly 
                      value="34.5" 
                      className="w-full bg-surface-highest/10 border-b border-outline/30 px-4 py-4 font-mono text-lg font-bold text-primary focus:outline-none"
                    />
                    <span className="absolute right-4 top-1/2 -translate-y-1/2 text-[10px] font-mono text-outline font-bold">{t("meters")}</span>
                  </div>
                </div>
              </div>
              ...
              <div className="p-6 bg-surface-highest/10 border border-outline/10 relative overflow-hidden">
                <div className="flex justify-between items-center mb-8 relative z-10">
                  <h4 className="text-sm font-bold text-on-surface tracking-tight uppercase flex items-center gap-2">
                    <ShieldCheck size={16} className="text-secondary" /> {t("hullReinforcement")}
                  </h4>
                  <span className="bg-secondary/10 text-secondary px-3 py-1 text-[9px] font-bold font-mono border border-secondary/20 rounded">{t("premiumSteelGrade")}</span>
                </div>
                <div className="space-y-6 relative z-10">
                  <div className="space-y-2">
                    <div className="flex justify-between text-[10px] font-bold font-mono text-on-surface-variant uppercase tracking-wider">
                      <span>{t("bowStrengthIndex")}</span>
                  ...
                  <div className="space-y-2">
                    <div className="flex justify-between text-[10px] font-bold font-mono text-on-surface-variant uppercase tracking-wider">
                      <span>{t("midshipStrengthIndex")}</span>
          ...
          <div className="lg:col-span-5 space-y-8">
              ...
              <div className="aspect-video relative overflow-hidden">
                ...
                <div className="absolute top-6 left-6 flex flex-col gap-1">
                  <div className="flex items-center gap-2 text-secondary">
                    <Video size={14} />
                    <span className="text-[10px] font-bold font-mono tracking-widest uppercase">{t("virtualBridgeFeed")}</span>
                  </div>
                ...
                <div className="absolute bottom-6 left-6 right-6 grid grid-cols-3 gap-3">
                  ...
                  <div className="bg-surface/80 backdrop-blur-md p-3 border border-outline/20">
                    <p className="text-[8px] font-bold font-mono text-on-surface-variant uppercase mb-1">{t("iceThick")}</p>
                    <p className="text-lg font-bold font-mono text-secondary">2.8<span className="text-[9px] ml-1">M</span></p>
                  </div>
                  <div className="bg-surface/80 backdrop-blur-md p-3 border border-outline/20">
                    <p className="text-[8px] font-bold font-mono text-on-surface-variant uppercase mb-1">{t("hullLoad")}</p>
            ...
            <div className="technical-card p-8 bg-surface-highest/10 border-outline/10">
               <div className="flex justify-between items-center mb-8 border-b border-outline/10 pb-4">
                <h3 className="text-[11px] font-bold font-mono text-on-surface-variant tracking-[0.3em] uppercase">{t("classPerformance")}</h3>
                <span className="text-secondary font-bold font-mono text-[11px]">{vessel.iceClass} {t("rating")}</span>
              </div>
              
              <div className="space-y-4">
                <div className="flex items-center justify-between group">
                  <span className="text-[11px] font-bold font-mono text-on-surface-variant uppercase tracking-wider group-hover:text-on-surface transition-colors">{t("multiYearIceEntry")}</span>
                  <CheckCircle2 size={16} className="text-green-500" />
                </div>
                <div className="flex items-center justify-between group">
                  <span className="text-[11px] font-bold font-mono text-on-surface-variant uppercase tracking-wider group-hover:text-on-surface transition-colors">{t("continuousMotion")}</span>
                  <CheckCircle2 size={16} className="text-green-500" />
                </div>
                <div className="flex items-center justify-between group">
                  <span className="text-[11px] font-bold font-mono text-on-surface-variant uppercase tracking-wider group-hover:text-on-surface transition-colors">{t("rammingEndurance")}</span>
              ...
              <div className="mt-10 pt-8 border-t border-outline/10">
                <h4 className="text-[10px] font-bold font-mono text-on-surface-variant tracking-[0.2em] uppercase mb-6">{t("predictedEmissionsProfile")}</h4>
